...
fragmentRouter.get('/user', authMiddleware, fragmentController.getUserFragments);
fragmentRouter.get('/user-stats', authMiddleware, fragmentController.getUserFragmentsStats);
...
fragmentRouter.patch('/:id/status/:status', authMiddleware, fragmentController.changeFragmentStatus)
fragmentRouter.delete("/:id", authMiddleware, fragmentController.deleteFragment);
fragmentRouter.delete("/:fragmentId/:replyId", authMiddleware, fragmentController.deleteReply);

// Reply routes
fragmentRouter.post("/:id/replies", authMiddleware, fragmentController.addReply);
